...
Tinytest.add('Keypress - multiple modifiers', function (test) {
  ...
  test.isTrue(Keypress.is(Keypress.Keys.a, {shiftKey: true, altKey: false, ctrlKey: true}));
  test.isFalse(Keypress.is(Keypress.Keys.a, {shiftKey: true}));
  test.isFalse(Keypress.is(Keypress.Keys.a, {ctrlKey: true}));
  test.isFalse(Keypress.is(Keypress.Keys.a, {shiftKey: true, altKey: true, ctrlKey: true}));
  trigger("keyup");
  test.isFalse(Keypress.is(Keypress.Keys.a, {shiftKey: true, ctrlKey: true}));
});

Tinytest.add('Keypress - all modifiers', function (test) {
  trigger("keydown", Keypress.Keys.a, {shiftKey: true, ctrlKey: true, altKey: true, metaKey: true});
  test.isFalse(Keypress.is(Keypress.Keys.a));
  test.isTrue(Keypress.is(Keypress.Keys.a, {shiftKey: true, ctrlKey: true, altKey: true, metaKey: true}));

  test.isFalse(Keypress.is(Keypress.Keys.a, {shiftKey: true, altKey: true, ctrlKey: true}));
  trigger("keyup");
  test.isFalse(Keypress.is(Keypress.Keys.a, {shiftKey: true, ctrlKey: true, altKey: true, metaKey: true}));
});
